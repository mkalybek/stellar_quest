...
def generate_hot_jupiter(temperature):
    pass
...
scale = 15000.0  # Increase scale to smooth out the bands and create large swirling patterns
octaves = 4    # Fewer octaves for smoother, more fluid cloud layers

# Gas giant colors (inspired by Jupiter/Saturn-like gas bands)
#gas_color_1 = (255, 223, 186)  # Light beige for high atmospheric layers
gas_color_1 = (200, 200, 200)
gas_color_2 = (255, 140, 0)    # Orange for mid-layer gases
