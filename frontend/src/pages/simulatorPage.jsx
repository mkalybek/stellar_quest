...
const SimulatorPage = () => {
    ...
    if (params.planetType === "gasgiant") {
        planetType = "Gas Giant Planet";
    } else if (params.planetType === "earthtype") {
        planetType = "Earth Type Planet";
    } else {
        correct = false;
        planetType = "Planet type is not correct";
    }
